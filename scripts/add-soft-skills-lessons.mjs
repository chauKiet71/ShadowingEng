/**
 * Thêm category "Kỹ năng mềm" + 5 bài từ nd_ky_nang_mem.txt
 * EN tách theo câu; VI dịch bằng OpenAI (OPENAI_API_KEY).
 *
 * Usage:
 *   node scripts/add-soft-skills-lessons.mjs
 *   node scripts/add-soft-skills-lessons.mjs "C:/Users/DELL/Downloads/nd_ky_nang_mem.txt"
 */
...
const sourcePath =
  process.argv[2] || 'C:/Users/DELL/Downloads/nd_ky_nang_mem.txt';

const CATEGORY_ID = '20';
const TOPIC = 'Kỹ năng mềm';
const START_LESSON_NUM = 216;

const LESSON_META = [
  {
    title: 'Quản lý thời gian',
    description: 'Lập kế hoạch và dùng thời gian hiệu quả hơn mỗi ngày',
    thumb: 'photo-1506784983877-45594efa4cbe',
  },
  {
    title: 'Đặt mục tiêu',
    description: 'Đặt mục tiêu rõ ràng và theo dõi tiến độ thực hiện',
    thumb: 'photo-1484480974693-6ca0a78fb36b',
  },
  {
    title: 'Giao tiếp hiệu quả',
    description: 'Nói rõ ràng, lắng nghe chủ động và ứng xử lịch sự',
    thumb: 'photo-1521791136064-7986c2920216',
  },
  {
    title: 'Làm việc nhóm',
    description: 'Hợp tác, chia sẻ và hỗ trợ lẫn nhau trong nhóm',
    thumb: 'photo-1522071820081-009f0129c71c',
  },
  {
    title: 'Giải quyết vấn đề',
    description: 'Phân tích tình huống và tìm giải pháp hiệu quả',
...
function ensureCategory() {
  ...
  writeFileSync(categoriesPath, src);
  console.log(`Added category ${CATEGORY_ID}: Kỹ năng mềm`);
}
