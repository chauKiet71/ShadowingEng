/**
 * Thêm category "Tâm lý học" + 10 bài từ ndth72.txt
 * EN tách theo câu; VI dịch bằng OpenAI (OPENAI_API_KEY).
 *
 * Usage:
 *   node scripts/add-psychology-lessons.mjs
 *   node scripts/add-psychology-lessons.mjs "C:/Users/DELL/Downloads/ndth72.txt"
 */
...
const sourcePath =
  process.argv[2] || 'C:/Users/DELL/Downloads/ndth72.txt';

const CATEGORY_ID = '21';
const TOPIC = 'Tâm lý học';
const START_LESSON_NUM = 226;

const LESSON_META = [
  {
    title: 'Sức khỏe tinh thần',
    description: 'Chăm sóc tinh thần để sống cân bằng và hiệu quả hơn',
    thumb: 'photo-1506126613408-eca07ce68773',
  },
  {
    title: 'Hiểu về cảm xúc',
    description: 'Nhận biết và kiểm soát cảm xúc trong đời sống hằng ngày',
    thumb: 'photo-1529156069898-49953e39b3ac',
  },
  {
    title: 'Quản lý căng thẳng',
    description: 'Giảm stress và giữ bình tĩnh khi gặp áp lực',
    thumb: 'photo-1517836357463-d25dfeac3438',
  },
  {
    title: 'Sự tự tin',
    description: 'Xây dựng niềm tin vào bản thân và vượt qua thử thách',
    thumb: 'photo-1522202176988-66273c2fd55f',
  },
  {
    title: 'Suy nghĩ tích cực',
    description: 'Tập trung vào giải pháp và duy trì thái độ lạc quan',
    thumb: 'photo-1491438590914-bc09fcaaf77a',
  },
  {
    title: 'Nhận thức bản thân',
    description: 'Hiểu điểm mạnh, điểm yếu để phát triển bản thân',
    thumb: 'photo-1488190211105-8b0e65b80b4e',
  },
  {
    title: 'Động lực và thành công',
    description: 'Duy trì động lực để đạt mục tiêu và tiến bộ mỗi ngày',
    thumb: 'photo-1434030216411-0b793f4b4173',
  },
  {
    title: 'Sự đồng cảm',
    description: 'Thấu hiểu cảm xúc người khác để gắn kết tốt hơn',
    thumb: 'photo-1511895426328-dc8714191300',
  },
  {
    title: 'Thói quen và hành vi',
    description: 'Xây dựng thói quen tích cực để phát triển bản thân',
    thumb: 'photo-1484480974693-6ca0a78fb36b',
  },
  {
    title: 'Tâm lý học trong học tập',
    description: 'Hiểu cách học hiệu quả dựa trên tâm lý học',
...
function ensureCategory() {
  ...
  writeFileSync(categoriesPath, src);
  console.log(`Added category ${CATEGORY_ID}: Tâm lý học`);
}
